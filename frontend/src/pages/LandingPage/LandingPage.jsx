              ...
              <div className="hero-content">
                <div className="space-y-4">
                  ...
                  <h1 className="hero-title">
                    Complete School ERP Solution for Modern Education
                  </h1>
                  <p className="hero-description">
                    Streamline your school operations with our comprehensive ERP
                    system. Manage students, teachers, academics, and finances
            ...
            <div className="section-header">
              <div className="space-y-4">
                ...
                <p className="section-description">
                  Our comprehensive ERP system covers every aspect of school
                  management, from admissions to graduation.
                </p>
              </div>
            </div>
            <div className="features-grid">
              ...
              <Card hover={true}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Streamline curriculum, timetables, and academic processes
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="feature-list">
              ...
              <Card hover={true}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Real-time attendance monitoring for students and staff
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="feature-list">
              ...
              <Card hover={true}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Comprehensive financial management and fee collection
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="feature-list">
              ...
              <Card hover={true}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Seamless communication between school, parents, and students
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ul className="feature-list">
              ...
              <div className="benefits-content">
                <div className="space-y-4">
                  ...
                  <h2 className="section-title">
                    Why Schools Choose CampusHub
                  </h2>
                  <p className="section-description">
                    Join thousands of schools worldwide who have transformed
                    their operations with our ERP system.
                  </p>
                </div>
          ...
          <div className="container">
            <div className="section-header">
              <div className="space-y-4">
                ...
                <p className="section-description">
                  See what school administrators and educators are saying about
                  CampusHub.
                </p>
              </div>
            </div>
            <div className="testimonials-grid">
              <Card>
                ...
                <CardContent>
                  <p className="testimonial-content">
                    "CampusHub has completely transformed how we manage our
                    school. The automation features have saved us countless
                    hours."
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="testimonial-content">
                    "The parent portal is fantastic. Parents love being able to
              ...
              <Card>
                ...
                <CardContent>
                  <p className="testimonial-content">
                    ...
                    incredibly responsive. Highly recommended!"
                  </p>
                  <div className="testimonial-author">
                    <div className="author-avatar">
          ...
          <div className="container">
            <div className="section-header">
              <div className="space-y-4">
                ...
                <p className="section-description">
                  Choose the plan that fits your school size and needs. All
                  plans include core features and 24/7 support.
                </p>
              </div>
            </div>
          ...
          <div className="container">
            <div className="section-header">
              <div className="space-y-4">
                ...
                <p className="section-description">
                  Join thousands of schools worldwide. Start your free trial
                  today and see the difference CampusHub can make.
                </p>
              </div>
